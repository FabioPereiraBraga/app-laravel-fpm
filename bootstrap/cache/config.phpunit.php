<?php return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'sqlite',
        'url' => NULL,
        'database' => 'code_micro_video_test',
        'prefix' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'gcs',
        'project_id' => 'curso-micro-servico',
        'key_file' => '/var/www/storage/credentials/google/curso-micro-servico-storage.json',
        'bucket' => 'videos-codeflix',
        'path_prefix' => NULL,
        'storage_api_uri' => 'https://storage.cloud.google.com/videos-codeflix',
        'visibility' => 'public',
      ),
      'local' => 
      array (
